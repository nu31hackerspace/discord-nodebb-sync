...
function createImporter({ db, User, Topics, Categories, assets, discordOAuth = null, log = console, mappings = null }) {
  ...
  const importer = createImportService({ Topics, mappings: repository, users, categories, content });
